    ...
    <div class="holder">
        <div class="sub-title red">
            ...
            <div class="translation">
            	<input type="checkbox" style="display:none;" checked name="ch_translate" value="<?php echo $home->row()->cont_id; ?>" class="ch_translate" />
                <?php
                ...
                echo form_close();
                $rules = array(
                    'view' => 'content/home/home_translation',
                    'data' => (serialize($home->result_array()))
                );
                ?>
