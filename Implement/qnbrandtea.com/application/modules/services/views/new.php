...
<?php echo form_open('services/addnew'); ?>
<div class="holder">
    <div class="sub-title">
        <?php
    ...
    <tr> 
        <td width="100" valign="middle">
            <label for="tea-1"><?php echo $this->lang->line('tea_name'),$this->lang->line('require'); ?></label>
             <?php echo form_input('txt_title', $this->input->post('txt_title') ? $this->input->post('txt_title') : '', 'id="tea-1"'); ?>
        </td>
    </tr>
    <tr> 
        <td width="100" valign="middle">
             <label for="tea-2"><?php echo $this->lang->line('description'); ?></label>
             <?php echo form_textarea('txt_dec', $this->input->post('txt_dec') ? $this->input->post('txt_dec') : '', 'id="tea-2"'); ?>          
        </td>
    </tr>
</table>
</div>
