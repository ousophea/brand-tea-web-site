        ...
        <tbody> 
            ...
            foreach ($tearelated->result_array() as $tea) {
                ...
                <tr> 
                    ...
                    <td width="100" id="translate-<?php echo $tea[field('teaId')]; ?>">
                        <input type="hidden" value="<?php echo table('teaLang'); ?>" name="table-translate-<?php echo $tea[field('teaId')]; ?>" />
                        <input type="hidden" value="<?php echo field('teaId'); ?>" name="field-translate-<?php echo $tea[field('teaId')]; ?>" />
                    </td>
