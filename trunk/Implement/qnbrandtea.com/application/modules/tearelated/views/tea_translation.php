<?php
echo form_open('tearelated/tea_translation/' . $itemId . '/' . $langId);
echo form_hidden('lan_title', $langTitle);
echo form_hidden('tea_id', $itemId);
...
$action = 'insert';
// Check existing data
$this->load->model('tearelated/mod_tearelated');
$langData = $this->mod_tearelated->checkLang($itemId, $langId);
