...
# Dumping data for table brand_tea_db.categories: ~5 rows (approximately)
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
INSERT INTO `categories` (`cate_id`, `cate_name`, `cate_description`, `cate_fields`, `lang_id`) VALUES
	(2, 'Tea', 'test 2', 'a:2:{s:5:"label";a:1:{i:0;s:17:"Short Description";}s:5:"field";a:1:{i:0;s:7:"Product";}}', 1),
	...
	(5, 'Waretea', 'yellow tea', 'a:2:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}}', 1),
	(7, 'Gif', 'test', 'a:2:{s:5:"label";b:0;s:5:"field";b:0;}', 1),
...
# Dumping data for table brand_tea_db.category_languages: ~3 rows (approximately)
...
INSERT INTO `contents` (`cont_id`, `cont_name`, `cont_description`, `men_id`, `lang_id`) VALUES
	(1, 'Welcome', '<p>home content edited! ddd ddd</p>', 1, 1),
	(2, 'About', '<p>About us testdsds sssdfsd</p>', 2, 1),
	(3, 'Contact', '<p>Catact ussdfjsdljfaaaaaaaasss</p>\r\n<p>asawww</p>\r\n<p>a</p>\r\n<p>sassssqqqsdfsdfsdf</p>', 3, 1),
...
# Dumping data for table brand_tea_db.content_languages: 8 rows
...
# Dumping structure for table brand_tea_db.footer
DROP TABLE IF EXISTS `footer`;
CREATE TABLE IF NOT EXISTS `footer` (
  `foo_id` int(11) NOT NULL AUTO_INCREMENT,
  `foo_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lang_id` smallint(6) NOT NULL,
  `foo_status` tinyint(1) NOT NULL,
  PRIMARY KEY (`foo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;

# Dumping data for table brand_tea_db.footer: ~3 rows (approximately)
/*!40000 ALTER TABLE `footer` DISABLE KEYS */;
INSERT INTO `footer` (`foo_id`, `foo_title`, `lang_id`, `foo_status`) VALUES
	(4, 'product category', 1, 1),
	(5, 'product group', 1, 1),
	(6, 'service', 1, 1);
/*!40000 ALTER TABLE `footer` ENABLE KEYS */;


# Dumping structure for table brand_tea_db.footer_languages
...
CREATE TABLE IF NOT EXISTS `footer_languages` (
  ...
  `foo_name` varchar(255) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`fol_id`)
) ENGINE=InnoDB DEFAULT CHARSET=gb2312 COLLATE=gb2312_bin;

# Dumping data for table brand_tea_db.footer_languages: ~0 rows (approximately)
/*!40000 ALTER TABLE `footer_languages` DISABLE KEYS */;
/*!40000 ALTER TABLE `footer_languages` ENABLE KEYS */;
...
# Dumping data for table brand_tea_db.groups: ~4 rows (approximately)
/*!40000 ALTER TABLE `groups` DISABLE KEYS */;
INSERT INTO `groups` (`gro_id`, `gro_name`, `gro_description`, `cate_id`, `lang_id`) VALUES
	(4, 'White tea dddddddddddddddddd', 'teadddddddddddddddddddddddddddddd', 2, 1),
	(5, 'Green tea', 'green tea', 5, 1),
	(6, 'Black tea', 'test test test', 7, 1),
	(7, 'China waretea', '', 5, 1);
...
# Dumping data for table brand_tea_db.group_languages: ~3 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `menus` (
  ...
  `men_mt_id` int(11) NOT NULL,
  `men_name` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `men_order` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`men_id`),
  KEY `men_mt_id` (`men_mt_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

# Dumping data for table brand_tea_db.menus: ~6 rows (approximately)
/*!40000 ALTER TABLE `menus` DISABLE KEYS */;
INSERT INTO `menus` (`men_id`, `men_mt_id`, `men_name`, `men_order`) VALUES
	(2, 1, 'HOME', '1'),
	(4, 1, 'Product', '3'),
	(9, 2, 'Category', '1'),
	(10, 2, 'Group', '2'),
...
# Dumping structure for table brand_tea_db.menu_detail
DROP TABLE IF EXISTS `menu_detail`;
CREATE TABLE IF NOT EXISTS `menu_detail` (
  `md_id` int(10) NOT NULL AUTO_INCREMENT,
  `md_men_id` int(10) NOT NULL DEFAULT '0',
  `md_lan_id` int(10) NOT NULL DEFAULT '0',
  `md_title` varchar(50) CHARACTER SET ucs2 DEFAULT NULL,
  PRIMARY KEY (`md_id`,`md_men_id`,`md_lan_id`),
  KEY `md_id` (`md_id`),
  KEY `FK_menu_detail_menus` (`md_men_id`),
  CONSTRAINT `FK_menu_detail_menus` FOREIGN KEY (`md_men_id`) REFERENCES `menus` (`men_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

# Dumping data for table brand_tea_db.menu_detail: ~15 rows (approximately)
/*!40000 ALTER TABLE `menu_detail` DISABLE KEYS */;
INSERT INTO `menu_detail` (`md_id`, `md_men_id`, `md_lan_id`, `md_title`) VALUES
	(1, 2, 1, 'Home'),
	(2, 2, 2, 'ទំពរ៍ដើម'),
	(3, 16, 2, 'ពត៍'),
	(4, 10, 1, 'Group'),
	...
	(13, 15, 2, 'សេវាកម្ម'),
	(14, 15, 3, '33'),
	(15, 2, 0, 'Customer Info'),
	(16, 16, 3, '33'),
	(18, 16, 1, 'Info');
/*!40000 ALTER TABLE `menu_detail` ENABLE KEYS */;


# Dumping structure for table brand_tea_db.menu_type
DROP TABLE IF EXISTS `menu_type`;
CREATE TABLE IF NOT EXISTS `menu_type` (
  `mt_id` int(11) NOT NULL AUTO_INCREMENT,
  `mt_title` varchar(50) DEFAULT NULL,
  `mt_status` int(10) DEFAULT NULL,
  PRIMARY KEY (`mt_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

# Dumping data for table brand_tea_db.menu_type: 2 rows
/*!40000 ALTER TABLE `menu_type` DISABLE KEYS */;
INSERT INTO `menu_type` (`mt_id`, `mt_title`, `mt_status`) VALUES
	(1, 'main menu', 1),
	(2, 'footer', 1);
...
CREATE TABLE IF NOT EXISTS `photos` (
  ...
  `pho_is_main_photo` int(11) DEFAULT '1',
  PRIMARY KEY (`pho_id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8;

# Dumping data for table brand_tea_db.photos: ~22 rows (approximately)
/*!40000 ALTER TABLE `photos` DISABLE KEYS */;
INSERT INTO `photos` (`pho_id`, `pho_url`, `pho_des`, `pro_id`, `pho_is_main_photo`) VALUES
	(3, 'dragon_well_tea_2_22.jpg', '', 2, 1),
	(9, '751.jpg', '', 5, 1),
	(10, '13302329653.jpg', '', 6, 1),
	(11, '1410.jpg', '', 7, 1),
	(12, '20140104030927_60822.jpg', '', 8, 1),
	(14, '4621.jpg', '', 14, 1),
	(19, '1386_2.jpg', '', 20, 1),
	(20, '1466.jpg', '', 20, 0),
	(23, '7511.jpg', '', 21, 1),
	(24, '133023296531.jpg', '', 22, 1),
	(25, 'IMG_7284-4.jpg', '', 23, 1),
	(26, 'IMG_7818-10.jpg', '', 23, 0),
	(27, 'IMG_7878-5.jpg', '', 23, 0),
	(29, '133023296532.jpg', '', 25, 1),
	(30, 'g0008-1_chinese_jasmine_tea_1_21.jpg', '', 26, 1),
	(31, '14101.jpg', '', 27, 1),
	(32, 'chinese_sage_1.jpg', '', 27, NULL),
	(33, 'chinese_sage_11.jpg', '', 28, 1),
	(34, '14102.jpg', '', 29, 1),
	(35, 'chinese_sage_12.jpg', '', 29, NULL),
	(36, 'chinese_sage_1_21.jpg', '', 29, NULL),
	(37, '133023296533.jpg', '', 30, 1);
...
# Dumping data for table brand_tea_db.products: ~16 rows (approximately)
...
INSERT INTO `products` (`pro_id`, `pro_name`, `pro_price`, `pro_qty`, `pro_fields`, `gro_id`, `lang_id`, `pro_related`, `pro_des`, `pro_knowledge_related`) VALUES
	(2, 'West Lake Dragon Well', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>Grete tea on cambodia</p>', 'b:0;'),
	(5, 'West Lake Dragon Wells', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:17:"Short Description";}s:5:"field";a:1:{i:0;s:7:"Product";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 4, 1, 'b:0;', '<p>fsdfs</p>\r\n<p>fsdf</p>', 'b:0;'),
	(6, 'West Lake Dragon Well2', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:17:"Short Description";}s:5:"field";a:1:{i:0;s:7:"Product";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 4, 1, 'b:0;', '<p>test</p>', 'b:0;'),
	(7, 'West Lake Dragon Well 22', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>222e</p>', 'b:0;'),
	(8, 'Silky Silver Needle Longjing 2', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>222</p>', 'b:0;'),
	(14, 'West Lake Dragon Wellssdfsdf', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>dfsdfsd</p>', 'b:0;'),
	(20, 'West Lake Dragon Well ssssss', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";b:0;s:5:"field";b:0;s:9:"hide_show";b:0;}', 6, 1, 'b:0;', '<p>sdasd</p>', 'b:0;'),
	(21, 'Dragon Well Tea sss', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>fsdfsdf</p>', 'b:0;'),
	(22, 'Silky Silver Needle Longjing dddw', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>czz</p>', 'b:0;'),
	(23, 'West Lake Dragon Wells 3', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>test</p>', 'b:0;'),
	(25, 'test1', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"hide";}}', 5, 1, 'b:0;', '<p>1</p>', 'b:0;'),
	(26, 'West Lake Dragon Wells 6', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>West Lake Dragon Wells 3</p>', 'b:0;'),
	(27, 'West Lake Dragon Wells 21', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>11</p>', 'b:0;'),
	(28, 'West Lake Dragon Wells 31', 'a:2:{s:5:"price";s:2:"10";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:3:"100";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>31</p>', 'b:0;'),
	(29, '1', 'a:2:{s:5:"price";s:1:"1";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:1:"1";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:17:"Short Description";}s:5:"field";a:1:{i:0;s:7:"Product";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 4, 1, 'b:0;', '<p>1</p>', 'b:0;'),
	(30, '2', 'a:2:{s:5:"price";s:1:"2";s:9:"hide_show";s:4:"show";}', 'a:2:{s:3:"qty";s:1:"2";s:9:"hide_show";s:4:"show";}', 'a:3:{s:5:"label";a:1:{i:0;s:1:"s";}s:5:"field";a:1:{i:0;s:1:"s";}s:9:"hide_show";a:1:{i:0;s:4:"show";}}', 5, 1, 'b:0;', '<p>2</p>', 'b:0;');
...
# Dumping data for table brand_tea_db.product_languages: ~9 rows (approximately)
...
INSERT INTO `product_languages` (`prl_id`, `lang_id`, `pro_id`, `pro_name`, `pro_des`, `pro_fields`) VALUES
	...
	(10, 2, 3, 'តែ Longjing', '<p>Nice and great</p>', 'a:3:{s:5:"label";b:0;s:5:"field";b:0;s:9:"hide_show";b:0;}'),
	(11, 2, 20, 'ផលិតផលតែ', '<p>ផលិតផលតែ</p>', 'a:3:{s:5:"label";b:0;s:5:"field";b:0;s:9:"hide_show";b:0;}');
...
# Dumping data for table brand_tea_db.services_languages: 1 rows
...
# Dumping data for table brand_tea_db.slideshow: ~10 rows (approximately)
/*!40000 ALTER TABLE `slideshow` DISABLE KEYS */;
INSERT INTO `slideshow` (`sli_id`, `sli_image`, `sli_description`, `sli_cat_id`) VALUES
	(7, 'homeheader3-seasonalcupoftea-_950x267.jpg', '<p>add on 10-04-2014 edited</p>', 5),
	(8, 'loose_leaf_herbal_teas_4_950x267.jpg', '<p>add on 10-04-2014</p>', 3),
	(9, 'loose_leaf_white_teas_5_950x267.jpg', '', 1),
	(11, 'loose_leaf_herbal_teas_4_950x267.jpg', '', 3),
	(12, 'loose_leaf_flower_teas_3_950x267.jpg', '', 4),
	(13, '13302329653_950x267.jpg', '', 4),
	(15, 'g0008-1_chinese_jasmine_tea_1_2_950x267.jpg', '', 5),
	(16, '13302329653_950x267.jpg', '', 5),
	(17, 'homeheader3-seasonalcupoftea-_950x267.jpg', '', 3),
	(18, 'loose_leaf_flower_teas_3_950x267.jpg', '', 1);
...
# Dumping data for table brand_tea_db.slideshow_languages: ~2 rows (approximately)
...
# Dumping data for table brand_tea_db.sli_categories: ~6 rows (approximately)
...
# Dumping data for table brand_tea_db.tearelated_languages: 6 rows
